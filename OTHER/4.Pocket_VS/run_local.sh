...
python biobb_pocket_vs.py --main-config input.yml --cavity-config cavity_input.yml --htvs-config htvs_input.yml --lig-lib $LIGAND_LIB_PATH --input $MODELS_PATH --pocket-res "$POCKET_RESIDUES" --until all
