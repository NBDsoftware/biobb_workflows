...
python biobb_docking_htvs.py --config input_HPC.yml --ligand_lib input/ligand_lib_large.smi --structure_path $STRUCTURE_PATH --input_pockets_zip $INPUT_POCKETS_ZIP --output $OUTPUT_PATH --num_top_ligands 50